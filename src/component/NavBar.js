            ...
            <Navbar collapseOnSelect expand="lg" bg="dark" variant="dark">
                ...
                <Navbar.Collapse id="responsive-navbar-nav">
                    <Nav className="mr-auto">
                        ...
                        <NavDropdown title="Deliver Management" id="collasible-nav-dropdown">
                            <NavDropdown.Item href="/deliver_details/add">Add Deliver Details</NavDropdown.Item>
                            <NavDropdown.Item href="/deliver_details/list">Deliver Details List</NavDropdown.Item>
                            {/*<NavDropdown.Item href="/books/delete">Delete Books</NavDropdown.Item>*/}
                            {/*<NavDropdown.Divider/>*/}
                            {/*<NavDropdown.Item href="#action/3.4">Separated link</NavDropdown.Item>*/}
                        </NavDropdown>
